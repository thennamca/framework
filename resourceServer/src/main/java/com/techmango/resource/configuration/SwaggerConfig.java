package com.techmango.resource.configuration;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
    	...
    	apiInfoBuilder.contact(new Contact("TechMango", "https://www.techmango.net/", "business@techmango.net"));
    	apiInfoBuilder.license("TechMango LICENSE, Version 1");
